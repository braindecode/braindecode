...
"""
# Authors: Hubert Jacob Banville <hubert.jbanville@gmail.com>
#          Lukas Alexander Wilhelm Gemein <l.gemein@gmail.com>
#
...
class BNCI2014001Dataset():
    def __init__(self, subject, path=None, force_update=False, update_path=False):
