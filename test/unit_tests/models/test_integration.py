...
from braindecode.models import SyncNet, EEGSimpleConv, EEGResNet, USleep, FBCNet, EEGInceptionMI
...
def test_model_has_drop_prob_parameter(model_class):
    ...
    if model_class in [SyncNet, EEGSimpleConv, EEGResNet, USleep, FBCNet, EEGInceptionMI]:
        pytest.skip(
