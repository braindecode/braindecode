...
def test_eeg_classifier():
    ...
    expected = [{'batches': [{'train_loss': 1.4175944328308105, 'train_batch_size': 32},
                   {'train_loss': 2.4414331912994385, 'train_batch_size': 32},
                   {'train_loss': 1.476792812347412, 'train_batch_size': 32},
                   {'valid_loss': 1.2322615385055542, 'valid_batch_size': 24}],
                  'epoch': 1,
                  'train_batch_count': 3,
                  'valid_batch_count': 1,
                 ...
                 {'batches': [{'train_loss': 0.9673743844032288, 'train_batch_size': 32},
                   {'train_loss': 1.218681812286377, 'train_batch_size': 32},
                   {'train_loss': 1.5651403665542603, 'train_batch_size': 32},
                   {'valid_loss': 1.123423457145691, 'valid_batch_size': 24}],
                  'epoch': 2,
                  'train_batch_count': 3,
                  'valid_batch_count': 1,
                 ...
                 {'batches': [{'train_loss': 1.1562678813934326, 'train_batch_size': 32},
                   {'train_loss': 1.5787755250930786, 'train_batch_size': 32},
                   {'train_loss': 1.306514859199524, 'train_batch_size': 32},
                   {'valid_loss': 1.037418007850647, 'valid_batch_size': 24}],
                  'epoch': 3,
                  'train_batch_count': 3,
                  'valid_batch_count': 1,
                  ...
                  'valid_trial_accuracy': 0.5,
                  'valid_trial_accuracy_best': False},
                 {'batches': [{'train_loss': 1.8480840921401978, 'train_batch_size': 32},
                   {'train_loss': 1.0466501712799072, 'train_batch_size': 32},
                   {'train_loss': 0.9813234210014343, 'train_batch_size': 32},
                   {'valid_loss': 0.9420649409294128, 'valid_batch_size': 24}],
                  'epoch': 4,
                  'train_batch_count': 3,
                  'valid_batch_count': 1,
