...
models_mandatory_parameters = [
    ...
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="se")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="gsop")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="fca")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="encnet")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="eca")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="ge")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="gct")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="srm")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="cbam")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="cat")),
    ("AttentionBaseNet", ["n_chans", "n_outputs", "n_times"],
     dict(attention_mode="catlite")),
