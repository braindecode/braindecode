...
Braindecode requires Python >= 3.11, PyTorch >= 2.4, and TorchAudio >= 2.4.
macOS requires Apple Silicon; Intel Macs are no longer supported because
`PyTorch discontinued macOS x86_64 binaries after 2.2
